...
<head>
    ...
    <title>Wooshi-Restaurant Template</title>
                                            ...
                                            <td width="140" height="60" align="center">
                                                <div class="imgpop">
                                                    <a target="_blank" href="#">
                                                        <img src="https://arad.wivert.net/emails/offers/logo.png" alt="" border="0" width="118" height="60" style="display:block; border:none; outline:none; text-decoration:none;">
                                                    </a>
                                                </div>
                                            </td>
                                        </tr>
                        ...
                        <table width="600" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth">
                            ...
                            <tr>
                                ...
                                <td align="center" st-image="banner-image">
                                    <div class="imgpop">
                                        <a target="_blank" href="#"><img width="600" border="0" height="300" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="https://arad.wivert.net/emails/offers/banner.jpg" class="banner"></a>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
                                                ...
                                                <table width="270" align="right" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                                    ...
                                                    <tr>
                                                        <td width="270" align="center" class="devicewidth">
                                                            <img src="https://arad.wivert.net/emails/offers/twocolimg1.png" alt="" border="0" width="270" height="150" style="display:block; border:none; outline:none; text-decoration:none;" class="colimg2">
                                                        </td>
                                                    </tr>
                                                    <!-- title -->
                                                    <tr>
                                                        <td width="270" bgcolor="#d41b29" height="50">
                                                            ...
                                                            <table width="48" align="right" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #000000;">
                                                                <tbody>
                                                                <tr>
                                                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #ffffff;" bgcolor="#000000" align="center" height="50" >
                                                                        $20
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <table width="270" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                                    ...
                                                    <tr>
                                                        <td width="270" align="center" class="devicewidth">
                                                            <img src="https://arad.wivert.net/emails/offers/twocolimg2.png" alt="" border="0" width="270" height="150" style="display:block; border:none; outline:none; text-decoration:none;" class="colimg2">
                                                        </td>
                                                    </tr>
                                                    <!-- title -->
                                                    <tr>
                                                        <td width="270" bgcolor="#d41b29" height="50">
                                                            ...
                                                            <table  width="48" align="right" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #000000;">
                                                                <tbody>
                                                                <tr>
                                                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #ffffff;" bgcolor="#000000" height="50" align="center">
                                                                        $30
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                ...
                                                <table width="140" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidthinner">
                                                    ...
                                                    <tr>
                                                        <td width="140" height="90" align="center">
                                                            <img src="https://arad.wivert.net/emails/offers/blog.png" alt="" border="0" width="140" height="90" style="display:block; border:none; outline:none; text-decoration:none;" label="articleimage">
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                        ...
                        <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                            ...
                            <tr>
                                <td align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 13px;color: #ffffff" st-content="preheader">
                                    Don't want to receive email Updates? <a href="#" style="text-decoration: none; color: #d41b29">Unsubscribe here </a>
                                </td>
                            </tr>
                            <!-- Spacing -->
                            <tr>
